...
static const struct {
  ...
  {static_cast<ExifTag>(MNOTE_FUJI_TAG_SHARPNESS),
    { {1, N_("Softest")},
      {2, N_("Soft")},
      {3, N_("Normal")},
      {4, N_("Hard")},
      ...
      {0xFFFF, N_("Off")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_WHITE_BALANCE),
    { {0, N_("Auto")},
      {0x100, N_("Daylight")},
      {0x200, N_("Cloudy")},
      ...
      {0xF00, N_("Custom")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_COLOR),
    { {0, N_("Standard")},
      ...
      {0x8000, N_("Film simulation mode")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_TONE),
    { {0, N_("Standard")},
      ...
      {0x8000, N_("Film simulation mode")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_FLASH_MODE),
    { {0, N_("Auto")},
      {1, N_("On")},
      {2, N_("Off")},
      {3, N_("Red-eye reduction")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_MACRO),
    { {0, N_("Off")},
      {1, N_("On")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_FOCUS_MODE),
    { {0, N_("Auto")},
      {1, N_("Manual")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_SLOW_SYNC),
    { {0, N_("Off")},
      {1, N_("On")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_PICTURE_MODE),
    { {0, N_("Auto")},
      {1, N_("Portrait")},
      {2, N_("Landscape")},
      {4, N_("Sports")},
      ...
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_CONT_TAKING),
    { {0, N_("Off")},
      {1, N_("On")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_FINEPIX_COLOR),
    { {0x00, N_("F-Standard")},
      {0x10, N_("F-Chrome")},
      {0x30, N_("F-B&W")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_BLUR_CHECK),
    { {0, N_("No blur")},
      {1, N_("Blur warning")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_FOCUS_CHECK),
    { {0, N_("Focus good")},
      {1, N_("Out of focus")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_AUTO_EXPOSURE_CHECK),
    { {0, N_("AE good")},
      {1, N_("Over exposed")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_DYNAMIC_RANGE),
    { {1, N_("Standard")},
      {3, N_("Wide")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_FILM_MODE),
    { {0, N_("F0/Standard")},
      ...
      {0x0400, N_("F4/Velvia")},
      {0, NULL}}},
  { static_cast<ExifTag>(MNOTE_FUJI_TAG_DYNAMIC_RANGE_SETTING),
    { {0, N_("Auto (100-400%)")},
      {1, N_("RAW")},
      ...
      {0, NULL}}},
#endif
  {static_cast<ExifTag>(MNOTE_FUJI_TAG_VERSION), {{0, NULL}}}
};


char *MnoteFujiEntry::mnote_fuji_entry_get_value (char *val, unsigned int maxlen)
{
	ExifLong  vl;
	ExifSLong vsl;
	ExifShort vs, vs2;
	...
	switch (tag) {
	  case MNOTE_FUJI_TAG_VERSION:
		...
		memcpy (val, data, MIN(maxlen, size));
		break;
