...
const struct TagEntry {
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_VERSION_ID), "GPSVersionID", N_("GPS Tag Version"),
	...
	{static_cast<ExifTag>(EXIF_TAG_INTEROPERABILITY_INDEX), "InteroperabilityIndex",
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_LATITUDE_REF), "GPSLatitudeRef", N_("North or South Latitude"),
	 N_("Indicates whether the latitude is north or south latitude. The "
	    "ASCII value 'N' indicates north latitude, and 'S' is south "
	    "latitude."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_INTEROPERABILITY_VERSION), "InteroperabilityVersion",
	 N_("Interoperability Version"), "",
	 { ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_OOOO } },
	{static_cast<ExifTag>(EXIF_TAG_GPS_LATITUDE), "GPSLatitude", N_("Latitude"),
	 ...
	 ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_LONGITUDE_REF), "GPSLongitudeRef", N_("East or West Longitude"),
	 N_("Indicates whether the longitude is east or west longitude. "
	    "ASCII 'E' indicates east longitude, and 'W' is west "
	    "longitude."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_LONGITUDE), "GPSLongitude", N_("Longitude"),
	 ...
	 ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_ALTITUDE_REF), "GPSAltitudeRef", N_("Altitude Reference"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_ALTITUDE), "GPSAltitude", N_("Altitude"),
	 N_("Indicates the altitude based on the reference in GPSAltitudeRef. "
	    ...
	    "is meters."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_TIME_STAMP), "GPSTimeStamp", N_("GPS Time (Atomic Clock)"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_SATELLITES), "GPSSatellites", N_("GPS Satellites"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_STATUS), "GPSStatus", N_("GPS Receiver Status"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_MEASURE_MODE), "GPSMeasureMode", N_("GPS Measurement Mode"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DOP), "GPSDOP", N_("Measurement Precision"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_SPEED_REF), "GPSSpeedRef", N_("Speed Unit"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_SPEED), "GPSSpeed", N_("Speed of GPS Receiver"),
	 N_("Indicates the speed of GPS receiver movement."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_TRACK_REF), "GPSTrackRef", N_("Reference for direction of movement"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_TRACK), "GPSTrack", N_("Direction of Movement"),
         N_("Indicates the direction of GPS receiver movement. The range "
            "of values is from 0.00 to 359.99."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_IMG_DIRECTION_REF), "GPSImgDirectionRef", N_("GPS Image Direction Reference"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_IMG_DIRECTION), "GPSImgDirection", N_("GPS Image Direction"),
	 N_("Indicates the direction of the image when it was captured. The range of values is "
	    "from 0.00 to 359.99."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_MAP_DATUM), "GPSMapDatum", N_("Geodetic Survey Data Used"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_LATITUDE_REF), "GPSDestLatitudeRef", N_("Reference For Latitude of Destination"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_LATITUDE), "GPSDestLatitude", N_("Latitude of Destination"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_LONGITUDE_REF), "GPSDestLongitudeRef", N_("Reference for Longitude of Destination"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_LONGITUDE), "GPSDestLongitude", N_("Longitude of Destination"),
         ...
         ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_BEARING_REF), "GPSDestBearingRef", N_("Reference for Bearing of Destination"),
         N_("Indicates the reference used for giving the bearing to "
            "the destination point. 'T' denotes true direction and 'M' is "
            "magnetic direction."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_BEARING), "GPSDestBearing", N_("Bearing of Destination"),
         N_("Indicates the bearing to the destination point. The range "
            "of values is from 0.00 to 359.99."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_DISTANCE_REF), "GPSDestDistanceRef", N_("Reference for Distance to Destination"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DEST_DISTANCE), "GPSDestDistance", N_("Distance to Destination"),
	 N_("Indicates the distance to the destination point."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_PROCESSING_METHOD), "GPSProcessingMethod", N_("Name of GPS Processing Method"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_AREA_INFORMATION), "GPSAreaInformation", N_("Name of GPS Area"),
	...
	{static_cast<ExifTag>(EXIF_TAG_GPS_DATE_STAMP), "GPSDateStamp", N_("GPS Date"),
         N_("A character string recording date and time information "
            ...
            "NULL."), ESL_GPS},
	{static_cast<ExifTag>(EXIF_TAG_GPS_DIFFERENTIAL), "GPSDifferential", N_("GPS Differential Correction"),
         N_("Indicates whether differential correction is applied to the "
            "GPS receiver."), ESL_GPS},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_NEW_SUBFILE_TYPE), "NewSubfileType",
	 N_("New Subfile Type"), N_("A general indication of the kind of data "
	    "contained in this subfile.")},
	{static_cast<ExifTag>(EXIF_TAG_IMAGE_WIDTH), "ImageWidth", N_("Image Width"),
	...
	{static_cast<ExifTag>(EXIF_TAG_IMAGE_LENGTH), "ImageLength", N_("Image Length"),
	 N_("The number of rows of image data. In JPEG compressed data a "
	    "JPEG marker is used instead of this tag."), 
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_BITS_PER_SAMPLE), "BitsPerSample", N_("Bits per Sample"),
	 ...
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_COMPRESSION), "Compression", N_("Compression"),
	...
	{static_cast<ExifTag>(EXIF_TAG_PHOTOMETRIC_INTERPRETATION), "PhotometricInterpretation",
	 N_("Photometric Interpretation"),
	 N_("The pixel composition. In JPEG compressed data a JPEG "
	    "marker is used instead of this tag."),
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_FILL_ORDER), "FillOrder", N_("Fill Order"), ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_DOCUMENT_NAME), "DocumentName", N_("Document Name"), ""},
	{static_cast<ExifTag>(EXIF_TAG_IMAGE_DESCRIPTION), "ImageDescription",
	...
	{static_cast<ExifTag>(EXIF_TAG_MAKE), "Make", N_("Manufacturer"),
	 N_("The manufacturer of the recording "
	    ...
	    "unknown."),
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_MODEL), "Model", N_("Model"),
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_STRIP_OFFSETS), "StripOffsets", N_("Strip Offsets"),
	 ...
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_ORIENTATION), "Orientation", N_("Orientation"),
	 N_("The image orientation viewed in terms of rows and columns."),
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SAMPLES_PER_PIXEL), "SamplesPerPixel",
	 ...
	 N_("The number of components per pixel. Since this standard applies "
	    ...
	    "tag."), 
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_ROWS_PER_STRIP), "RowsPerStrip", N_("Rows per Strip"),
	 N_("The number of rows per strip. This is the number of rows "
	    ...
	    "<StripByteCounts>."),
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_STRIP_BYTE_COUNTS), "StripByteCounts", N_("Strip Byte Count"),
	 N_("The total number of bytes in each strip. With JPEG compressed "
	    "data this designation is not needed and is omitted."),
	 { ESL_MMMN, ESL_MMMN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_X_RESOLUTION), "XResolution", N_("X-Resolution"),
	...
	{static_cast<ExifTag>(EXIF_TAG_Y_RESOLUTION), "YResolution", N_("Y-Resolution"),
	 N_("The number of pixels per <ResolutionUnit> in the <ImageLength> "
	    "direction. The same value as <XResolution> is designated."),
	 { ESL_MMMM, ESL_MMMM, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_PLANAR_CONFIGURATION), "PlanarConfiguration",
	...
	{static_cast<ExifTag>(EXIF_TAG_RESOLUTION_UNIT), "ResolutionUnit", N_("Resolution Unit"),
	 ...
	 { ESL_MMMM, ESL_MMMM, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_TRANSFER_FUNCTION), "TransferFunction",
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SOFTWARE), "Software", N_("Software"),
	 N_("This tag records the name and version of the software or "
	    ...
	    "unknown."),
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_DATE_TIME), "DateTime", N_("Date and Time"),
	 N_("The date and time of image creation. In this standard "
	    "(EXIF-2.1) it is the date and time the file was changed."),
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_ARTIST), "Artist", N_("Artist"),
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_WHITE_POINT), "WhitePoint", N_("White Point"),
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_PRIMARY_CHROMATICITIES), "PrimaryChromaticities",
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_SUB_IFDS), "SubIFDs", "SubIFD Offsets", N_("Defined by Adobe Corporation "
	    "to enable TIFF Trees within a TIFF file.")},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_TRANSFER_RANGE), "TransferRange", N_("Transfer Range"), ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_JPEG_PROC), "JPEGProc", "JPEGProc", ""},
	{static_cast<ExifTag>(EXIF_TAG_JPEG_INTERCHANGE_FORMAT), "JPEGInterchangeFormat",
	...
	{static_cast<ExifTag>(EXIF_TAG_JPEG_INTERCHANGE_FORMAT_LENGTH),
	 ...
	 N_("The number of bytes of JPEG compressed thumbnail data. This "
	    ...
	    "recorded in APP1."),
	 { ESL_NNNN, ESL_NNNM, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_YCBCR_COEFFICIENTS), "YCbCrCoefficients",
	...
	{static_cast<ExifTag>(EXIF_TAG_YCBCR_SUB_SAMPLING), "YCbCrSubSampling",
	...
	{static_cast<ExifTag>(EXIF_TAG_YCBCR_POSITIONING), "YCbCrPositioning",
	...
	{static_cast<ExifTag>(EXIF_TAG_REFERENCE_BLACK_WHITE), "ReferenceBlackWhite",
	 ...
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_XML_PACKET), "XMLPacket", N_("XML Packet"), N_("XMP Metadata")},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_RELATED_IMAGE_FILE_FORMAT), "RelatedImageFileFormat",
	 "RelatedImageFileFormat", ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_RELATED_IMAGE_WIDTH), "RelatedImageWidth",
	 "RelatedImageWidth", ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_RELATED_IMAGE_LENGTH), "RelatedImageLength",
	 "RelatedImageLength", ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_CFA_REPEAT_PATTERN_DIM), "CFARepeatPatternDim",
	 "CFARepeatPatternDim", ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_CFA_PATTERN), "CFAPattern",
	 N_("CFA Pattern"),
	...
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_BATTERY_LEVEL), "BatteryLevel", N_("Battery Level"), ""},
	{static_cast<ExifTag>(EXIF_TAG_COPYRIGHT), "Copyright", N_("Copyright"),
	 N_("Copyright information. In this standard the tag is used to "
	    ...
	    "as unknown."),
	 { ESL_OOOO, ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_EXPOSURE_TIME), "ExposureTime", N_("Exposure Time"),
	 N_("Exposure time, given in seconds (sec)."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FNUMBER), "FNumber", N_("F-Number"),
	 N_("The F number."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_IPTC_NAA), "IPTC/NAA", "IPTC/NAA", ""},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_IMAGE_RESOURCES), "ImageResources", N_("Image Resources Block"), ""},
	{static_cast<ExifTag>(EXIF_TAG_EXIF_IFD_POINTER), "ExifIfdPointer", "ExifIFDPointer",
	...
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_INTER_COLOR_PROFILE), "InterColorProfile",
	 "InterColorProfile", ""},
	{static_cast<ExifTag>(EXIF_TAG_EXPOSURE_PROGRAM), "ExposureProgram", N_("Exposure Program"),
	 N_("The class of the program used by the camera to set exposure "
	    "when the picture is taken."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SPECTRAL_SENSITIVITY), "SpectralSensitivity",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_GPS_INFO_IFD_POINTER), "GPSInfoIFDPointer", 
	...
	{static_cast<ExifTag>(EXIF_TAG_ISO_SPEED_RATINGS), "ISOSpeedRatings",
	 N_("ISO Speed Ratings"),
	 N_("Indicates the ISO Speed and ISO Latitude of the camera or "
	    "input device as specified in ISO 12232."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_OECF), "OECF", N_("Opto-Electronic Conversion Function"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_TIME_ZONE_OFFSET), "TimeZoneOffset", N_("Time Zone Offset"),
	 N_("Encodes time zone of camera clock relative to GMT.")},
	{static_cast<ExifTag>(EXIF_TAG_EXIF_VERSION), "ExifVersion", N_("Exif Version"),
	...
	{static_cast<ExifTag>(EXIF_TAG_DATE_TIME_ORIGINAL), "DateTimeOriginal",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_DATE_TIME_DIGITIZED), "DateTimeDigitized",
	 N_("Date and Time (Digitized)"),
	 N_("The date and time when the image was stored as digital data."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_COMPONENTS_CONFIGURATION), "ComponentsConfiguration",
	...
	{static_cast<ExifTag>(EXIF_TAG_COMPRESSED_BITS_PER_PIXEL), "CompressedBitsPerPixel",
	...
	{static_cast<ExifTag>(EXIF_TAG_SHUTTER_SPEED_VALUE), "ShutterSpeedValue", N_("Shutter Speed"),
	 N_("Shutter speed. The unit is the APEX (Additive System of "
	    "Photographic Exposure) setting."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_APERTURE_VALUE), "ApertureValue", N_("Aperture"),
	 N_("The lens aperture. The unit is the APEX value."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_BRIGHTNESS_VALUE), "BrightnessValue", N_("Brightness"),
	 N_("The value of brightness. The unit is the APEX value. "
	    "Ordinarily it is given in the range of -99.99 to 99.99."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_EXPOSURE_BIAS_VALUE), "ExposureBiasValue",
	 N_("Exposure Bias"),
	 N_("The exposure bias. The units is the APEX value. Ordinarily "
	    "it is given in the range of -99.99 to 99.99."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_MAX_APERTURE_VALUE), "MaxApertureValue", N_("Maximum Aperture Value"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUBJECT_DISTANCE), "SubjectDistance",
	 N_("Subject Distance"),
	 N_("The distance to the subject, given in meters."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_METERING_MODE), "MeteringMode", N_("Metering Mode"),
	 N_("The metering mode."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_LIGHT_SOURCE), "LightSource", N_("Light Source"),
	 N_("The kind of light source."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FLASH), "Flash", N_("Flash"),
	 N_("This tag is recorded when an image is taken using a strobe "
	    "light (flash)."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FOCAL_LENGTH), "FocalLength", N_("Focal Length"),
	 N_("The actual focal length of the lens, in mm. Conversion is not "
	    "made to the focal length of a 35 mm film camera."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUBJECT_AREA), "SubjectArea", N_("Subject Area"),
	 N_("This tag indicates the location and area of the main subject "
	    "in the overall scene."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_TIFF_EP_STANDARD_ID), "TIFF/EPStandardID", N_("TIFF/EP Standard ID"), ""},
	{static_cast<ExifTag>(EXIF_TAG_MAKER_NOTE), "MakerNote", N_("Maker Note"),
	 N_("A tag for manufacturers of Exif writers to record any desired "
	    "information. The contents are up to the manufacturer."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_USER_COMMENT), "UserComment", N_("User Comment"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUB_SEC_TIME), "SubsecTime", N_("Sub-second Time"),
	 N_("A tag used to record fractions of seconds for the "
	    "<DateTime> tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUB_SEC_TIME_ORIGINAL), "SubSecTimeOriginal",
	 N_("Sub-second Time (Original)"),
	 N_("A tag used to record fractions of seconds for the "
	    "<DateTimeOriginal> tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUB_SEC_TIME_DIGITIZED), "SubSecTimeDigitized",
	 N_("Sub-second Time (Digitized)"),
	 N_("A tag used to record fractions of seconds for the "
	    "<DateTimeDigitized> tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 (Microsoft extension) */
	{static_cast<ExifTag>(EXIF_TAG_XP_TITLE), "XPTitle", N_("XP Title"),
	 N_("A character string giving the title of the image, encoded in "
	    "UTF-16LE."),
	 { ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 (Microsoft extension) */
	{static_cast<ExifTag>(EXIF_TAG_XP_COMMENT), "XPComment", N_("XP Comment"), 
	 N_("A character string containing a comment about the image, encoded "
	    "in UTF-16LE."),
	 { ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 (Microsoft extension) */
	{static_cast<ExifTag>(EXIF_TAG_XP_AUTHOR), "XPAuthor", N_("XP Author"), 
	 N_("A character string containing the name of the image creator, "
	    "encoded in UTF-16LE."),
	 { ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 (Microsoft extension) */
	{static_cast<ExifTag>(EXIF_TAG_XP_KEYWORDS), "XPKeywords", N_("XP Keywords"), 
	 N_("A character string containing key words describing the image, "
	    "encoded in UTF-16LE."),
	 { ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 (Microsoft extension) */
	{static_cast<ExifTag>(EXIF_TAG_XP_SUBJECT), "XPSubject", N_("XP Subject"), 
	 N_("A character string giving the image subject, encoded in "
	    "UTF-16LE."),
	 { ESL_OOOO, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FLASH_PIX_VERSION), "FlashPixVersion", "FlashPixVersion",
	 N_("The FlashPix format version supported by a FPXR file."),
	 { ESL_NNNN, ESL_NNNN, ESL_MMMM, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_COLOR_SPACE), "ColorSpace", N_("Color Space"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_MMMM, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_PIXEL_X_DIMENSION), "PixelXDimension", N_("Pixel X Dimension"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_NNNM, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_PIXEL_Y_DIMENSION), "PixelYDimension", N_("Pixel Y Dimension"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_NNNM, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_RELATED_SOUND_FILE), "RelatedSoundFile",
	 ...
	 N_("This tag is used to record the name of an audio file related "
	    ...
	    "audio file end."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_INTEROPERABILITY_IFD_POINTER), "InteroperabilityIFDPointer",
	 ...
	 N_("Interoperability IFD is composed of tags which stores the "
	    ...
	    "IFD."),
	 { ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FLASH_ENERGY), "FlashEnergy", N_("Flash Energy"),
	 N_("Indicates the strobe energy at the time the image is "
	    "captured, as measured in Beam Candle Power Seconds (BCPS)."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SPATIAL_FREQUENCY_RESPONSE), "SpatialFrequencyResponse",
	 ...
	 N_("This tag records the camera or input device spatial frequency "
	    ...
	    "12233."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FOCAL_PLANE_X_RESOLUTION), "FocalPlaneXResolution",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FOCAL_PLANE_Y_RESOLUTION), "FocalPlaneYResolution",
	 N_("Focal Plane Y-Resolution"),
	 N_("Indicates the number of pixels in the image height (V) direction "
	    "per <FocalPlaneResolutionUnit> on the camera focal plane."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FOCAL_PLANE_RESOLUTION_UNIT), "FocalPlaneResolutionUnit",
	 ...
	 N_("Indicates the unit for measuring <FocalPlaneXResolution> and "
	    ...
	    "<ResolutionUnit>."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUBJECT_LOCATION), "SubjectLocation",
	 N_("Subject Location"),
	 N_("Indicates the location of the main subject in the scene. The "
	    ...
	    "the Y row number."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_EXPOSURE_INDEX), "ExposureIndex", N_("Exposure Index"),
	 N_("Indicates the exposure index selected on the camera or "
	    "input device at the time the image is captured."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SENSING_METHOD), "SensingMethod", N_("Sensing Method"),
	 N_("Indicates the image sensor type on the camera or input "
	    "device."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FILE_SOURCE), "FileSource", N_("File Source"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SCENE_TYPE), "SceneType", N_("Scene Type"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_NEW_CFA_PATTERN), "CFAPattern",
	 N_("CFA Pattern"),
	 N_("Indicates the color filter array (CFA) geometric pattern of the "
	    "image sensor when a one-chip color area sensor is used. "
	    "It does not apply to all sensing methods."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_CUSTOM_RENDERED), "CustomRendered", N_("Custom Rendered"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_EXPOSURE_MODE), "ExposureMode", N_("Exposure Mode"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_WHITE_BALANCE), "WhiteBalance", N_("White Balance"),
	 N_("This tag indicates the white balance mode set when the image "
	    "was shot."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_DIGITAL_ZOOM_RATIO), "DigitalZoomRatio",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_FOCAL_LENGTH_IN_35MM_FILM), "FocalLengthIn35mmFilm",
	 ...
	 N_("This tag indicates the equivalent focal length assuming a "
	    ...
	    "FocalLength tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SCENE_CAPTURE_TYPE), "SceneCaptureType",
	 ...
	 N_("This tag indicates the type of scene that was shot. It can "
	    ...
	    "<SceneType> tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_GAIN_CONTROL), "GainControl", N_("Gain Control"),
	 N_("This tag indicates the degree of overall image gain "
	    "adjustment."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_CONTRAST), "Contrast", N_("Contrast"),
	 N_("This tag indicates the direction of contrast processing "
	    "applied by the camera when the image was shot."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SATURATION), "Saturation", N_("Saturation"),
	 N_("This tag indicates the direction of saturation processing "
	    "applied by the camera when the image was shot."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SHARPNESS), "Sharpness", N_("Sharpness"),
	 N_("This tag indicates the direction of sharpness processing "
	    "applied by the camera when the image was shot."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_DEVICE_SETTING_DESCRIPTION), "DeviceSettingDescription",
	 ...
	 N_("This tag indicates information on the picture-taking "
	    ...
	    "reader."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_SUBJECT_DISTANCE_RANGE), "SubjectDistanceRange",
	 N_("Subject Distance Range"),
	 N_("This tag indicates the distance to the subject."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{static_cast<ExifTag>(EXIF_TAG_IMAGE_UNIQUE_ID), "ImageUniqueID", N_("Image Unique ID"),
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_GAMMA), "Gamma", N_("Gamma"),
	 N_("Indicates the value of coefficient gamma.")},
	/* Not in EXIF 2.2 */
	{static_cast<ExifTag>(EXIF_TAG_PRINT_IMAGE_MATCHING), "PrintImageMatching", N_("PRINT Image Matching"),
	 N_("Related to Epson's PRINT Image Matching technology")},
	/* Not in EXIF 2.2 (from the Microsoft HD Photo specification) */
	{static_cast<ExifTag>(EXIF_TAG_PADDING), "Padding", N_("Padding"),
...
#endif
	{static_cast<ExifTag>(EXIF_TAG_NULL), NULL, NULL, NULL}
};
...
{
	return static_cast<ExifTag>((n < exif_tag_table_count ()) ? ExifTagTable[n].tag : 0);
}
...
{
	int i;
	struct TagEntry *entry = (TagEntry *)bsearch(&tag, ExifTagTable,
...
exif_tag_get_stuff (ExifTag tag, get_stuff_func func)
{
	...
	const ExifIfd ifds[EXIF_IFD_COUNT] = {
		EXIF_IFD_EXIF,
		EXIF_IFD_0,
		EXIF_IFD_1,
...
exif_tag_from_name (const char *name)
{
	...
	if (!name) return static_cast<ExifTag>(result);
	...
	return static_cast<ExifTag>(result);
}
